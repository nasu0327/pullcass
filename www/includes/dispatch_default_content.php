...
外部からの訪問者をお部屋までご案内することができません。",
        ...
        'love_hotel' => "・ホテルにチェックイン前からご予約は可能です。当店ホームページのスケジュールページから、お目当てのキャストの出勤日時をご確認下さい。スケジュールに掲載分の予定は事前予約も可能です。
・電話予約は営業時間内で受け付けております。ネット予約は24時間受け付けております。
・ホテル入室前に入室予定のホテルのエリアとホテル名を当店受付に伝えていただけると案内はスムーズです。その際にキャストの待ち時間などもお伝えいたします。
・キャストの到着時間前にホテルに入室して入室後は速やかにホテル名と部屋番号を当店受付にお伝え下さい。
・受付完了後はキャストが予定時刻に直接お部屋までお伺いいたします。",
    ];
