                ...
                <div class="scroll-container-x">
                    <div class="cast-cards cards-inline-flex">
                        <?php foreach ($newCasts as $cast): ?>
                            <div class="cast-card">
                                <a href="<?php echo castDetailUrl($cast['id'], 'new'); ?>" class="link-block">
                ...
                <div class="scroll-container-x">
                    <div class="cast-cards cards-inline-flex">
                        <?php foreach ($todayCasts as $cast): ?>
                            <div class="cast-card">
                                <a href="<?php echo castDetailUrl($cast['id'], 'today'); ?>" class="link-block">
                                    <div class="cast-image">
                                        <?php if ($cast['img1']): ?>
                                            <img src="<?php echo h($cast['img1']); ?>" alt="<?php echo h($cast['name']); ?>"
                                                loading="eager">
                    ...
                    <div class="cast-cards cards-inline-flex">
                        <?php foreach ($rankingCasts as $cast): ?>
                            ...
                            <div class="cast-card ranking-card">
                                <a href="<?php echo $detailId ? castDetailUrl($detailId, 'ranking') : '/app/front/cast/list.php'; ?>" class="link-block">
            ...
            foreach ($videos as $video):
                ...
                if (!empty($video['movie_1'])):
                    ...
                    <div class="video-item">
                        <a href="<?php echo castDetailUrl($video['id'], 'video'); ?>" class="video-link">
