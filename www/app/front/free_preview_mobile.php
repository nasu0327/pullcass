    ...
    <div id="preview-modal-overlay" class="modal-overlay">
        <div id="preview-modal" class="modal-content">
            <div style="margin-bottom: 15px;">
                ...
                <h3 style="margin: 0 0 12px 0; font-size: 18px; font-weight: bold; color: var(--pv-text-primary);">フリーページプレビューモード</h3>
            ...
            <div class="phone-frame">
                <div class="phone-inner">
                    ...
                    <div class="content-area">
                        <iframe
                            src="/free_preview?tenant=<?php echo urlencode($tenantSlug); ?>&id=<?php echo urlencode($pageId); ?>"
