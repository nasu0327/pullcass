...
for ($i = 1; $i <= 7; $i++) {
    ...
    if ($i === 1) {
        $scheduleLinks[] = ['url' => '/app/front/schedule/day1', 'text' => '本日の出勤'];
    } elseif ($i === 2) {
        $scheduleLinks[] = ['url' => '/app/front/schedule/day2', 'text' => '明日の出勤'];
    } else {
        $scheduleLinks[] = ['url' => "/app/front/schedule/day{$i}", 'text' => $date->format('n/j') . '(' . $dayLabel . ')の出勤'];
    }
}
...
<footer class="site-footer-standard">
    <div class="page-footer-content">
        <nav class="footer-nav-standard">
            <ul>
                <li><a href="/app/front/index"><?php echo h($shopName); ?></a></li>
                <li><a href="/app/front/top">トップ</a></li>
                <li><a href="/app/front/cast/list">在籍一覧</a></li>
                <?php foreach ($scheduleLinks as $link): ?>
                <li><a href="<?php echo h($link['url']); ?>"><?php echo h($link['text']); ?></a></li>
                <?php endforeach; ?>
                <li><a href="/app/front/system">料金システム</a></li>
                <li><a href="/app/front/hotel_list">ホテルリスト</a></li>
                <li><a href="/app/front/reviews">口コミ</a></li>
                <li><a href="/app/front/diary">動画・写メ日記</a></li>
                <li><a href="/app/front/yoyaku">ネット予約</a></li>
            </ul>
        </nav>
