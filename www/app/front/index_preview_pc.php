...
// プレビューURL（iframe内で表示）
$previewUrl = '/app/front/index_preview.php?tenant=' . urlencode($tenantSlug) . '&iframe_preview=1';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
    ...
    <script>
        ...
        function closePreview() {
            ...
            if (window.opener) {
                ...
                window.location.href = '/app/manage/index_layout/?tenant=<?php echo urlencode($tenantSlug); ?>';
            }
        }
    </script>
</body>
