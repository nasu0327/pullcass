...
<body>
    ...
    <main class="main-content">
        ...
        <nav class="breadcrumb">
            ...
            <a href="/top">トップ</a><span>»</span>キャスト一覧 |
        </nav>
                        ...
                        <a href="<?php echo castDetailUrl($cast['id']); ?>"
                            ...
                            <div class="cast-info" style="padding: 5px 3px;">
                                ...
                                <div
                                    ...
                                    <span
                                        style="color: var(--color-text); font-size: 0.9em; padding: 0;"><?php echo h($cast['age']); ?>歳</span>
                                    <span
                                        style="color: var(--color-text); font-size: 1.0em; margin-left: 5px; padding: 0;"><?php echo h($cast['cup']); ?>カップ</span>
                                </div>
                                <p class="cast-pr"
