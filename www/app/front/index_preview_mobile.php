...
<head>
    ...
    <style>
        ...
        .preview-container-mobile { width: 100%; box-sizing: border-box; }
    </style>
</head>
    ...
    <div id="preview-modal-overlay" class="modal-overlay">
        <div id="preview-modal" class="modal-content">
            <div style="margin-bottom: 15px;">
                ...
                <h3 style="margin: 0 0 12px 0; font-size: 18px; font-weight: bold; color: var(--pv-text-primary);">レイアウトプレビューモード</h3>
            ...
            <div class="phone-frame">
                <div class="phone-inner">
                    ...
                    <div class="content-area">
                        <iframe src="/app/front/index_preview.php?tenant=<?php echo urlencode($tenantSlug); ?>&mobile=1&iframe_preview=1" title="スマホプレビュー"></iframe>
                    </div>
