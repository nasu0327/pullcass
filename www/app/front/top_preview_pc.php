...
// プレビューURL（iframe内で表示）
$previewUrl = '/top_preview?tenant=' . urlencode($tenantSlug) . '&iframe_preview=1';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
    ...
    <title>PCプレビュー - トップページレイアウト</title>
...
<body class="preview-pc">
    ...
    <div id="preview-modal-overlay" class="modal-overlay">
        <div id="preview-modal" class="modal-content">
            ...
            <h3 class="modal-title">レイアウトプレビューモード</h3>
    ...
    <script>
        ...
        function closePreview() {
            ...
            if (window.opener) {
                ...
                window.location.href = '/app/manage/top_layout/?tenant=<?php echo urlencode($tenantSlug); ?>';
            }
        }
    </script>
</body>
