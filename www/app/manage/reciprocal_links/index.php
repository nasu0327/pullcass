    ...
    if (empty($alt_text) || empty($link_url)) {
        ...
        if ($banner_image_path) {
            try {
                ...
                if ($banner_image_path)
                    @unlink($upload_dir . basename($banner_image_path));
            }
        } else {
...
if (isset($_GET['success'])) {
    switch ($_GET['success']) {
        case '1':
            $success = '画像バナーを登録しました。';
            break;
        case '2':
            $success = 'カスタムコードを登録しました。';
            break;
        case '3':
            $success = '相互リンクを削除しました。';
            break;
        case '4':
            $success = '更新しました。';
            break;
                ...
                <div class="list-item" data-id="<?php echo $link['id']; ?>">
                    ...
                    <?php else: ?>
                        ...
                        <div class="list-item-info">
                            ...
                            <div style="margin-bottom: 5px;">
                                <strong>URL:</strong> <a href="<?php echo h($link['link_url']); ?>"
                                    target="_blank"><?php echo h(mb_strimwidth($link['link_url'], 0, 50, '...')); ?></a>
                            </div>
    ...
    <div class="modal-content">
        ...
        <div id="edit-code-form" style="display: none;">
            ...
            <div class="form-group">
                ...
                <textarea id="edit_custom_code" class="form-control" rows="6"
                    style="font-family: monospace;"></textarea>
            </div>
        </div>
