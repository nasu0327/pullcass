...
<div class="create-theme-grid">
    ...
    <form method="POST" action="?action=create_original&tenant=<?php echo urlencode($tenantSlug); ?>" style="display: contents;">
...
<!-- 公開中のテーマ -->
<?php
$publishedThemes = array_filter($themes, function($t) { return $t['status'] === 'published'; });
    ...
    <div class="theme-list">
        ...
        <div class="theme-item published">
            ...
            <div class="theme-actions">
                <a href="edit.php?id=<?php echo $theme['id']; ?>&tenant=<?php echo urlencode($tenantSlug); ?>" class="btn btn-primary">
...
<!-- 下書きテーマ -->
<?php
$draftThemes = array_filter($themes, function($t) { return $t['status'] === 'draft'; });
    ...
    .then(data => {
        if (data.success) {
            ...
            if (mode === 'mobile') {
                ...
                url = 'https://<?php echo h($tenantSlug); ?>.pullcass.com/app/front/top.php?preview=1';
