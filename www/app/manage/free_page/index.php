                ...
                <div class="pages-list" id="sortable-list">
                    <?php foreach ($pages as $p): ?>
                        <div class="page-card" data-id="<?php echo $p['id']; ?>">
                            ...
                            <div class="actions">
                                <a href="post.php?tenant=<?php echo h($tenantSlug); ?>&id=<?php echo $p['id']; ?>"
                                    class="btn-icon" title="編集">
                                    <i class="fas fa-edit"></i>
                                </a>
                                ...
                                <?php else: ?>
                                    <a href="preview.php?tenant=<?php echo h($tenantSlug); ?>&id=<?php echo $p['id']; ?>"
                                        target="_blank" class="btn-icon" title="プレビュー">
                ...
                <?php if ($totalPages > 1): ?>
                    <div class="pagination">
                        ...
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                            ...
                            <?php else: ?>
                                <a
                                    href="?tenant=<?php echo h($tenantSlug); ?>&status=<?php echo h($statusFilter); ?>&page=<?php echo $i; ?>">
                                    <?php echo $i; ?>
                                </a>
                            <?php endif; ?>
                        <?php endfor; ?>
